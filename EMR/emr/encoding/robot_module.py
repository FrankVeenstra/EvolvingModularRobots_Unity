...
class Module:
    def __init__(self, config, symbol_name : str, type : str = "EmergeModuleUnpacked", controller_reference = None, controller = None, parent : str = None, connection_site : str = None, angle = [0,0,0], scale = [1,1,1], number_of_connection_sites : int = 3, fix_controller : bool = False):
    ...
    def mutate(self, mutation_rate, mutation_spread,controller_mutation_rate):
        ...
        if (random.uniform(0,1)< mutation_rate):
            self.angle = ch.mutate_angle(self.angle, mutation_spread)
        # mutate controller
